...
public:
    ...
    /// Promote blocks and ancestors up to the hash to confirmed|indexed.
    bool confirm(const hash_digest& hash, bool positive, bool block_index);

    /// Demote all blocks at and above the given height to pooled.
    bool unconfirm(size_t from_height, bool block_index);
...
private:
    ...
    array_index read_index(array_index height,
