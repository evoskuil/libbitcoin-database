...
BOOST_AUTO_TEST_SUITE(memory_release_tests)

// release_candidates

BOOST_AUTO_TEST_CASE(memory_release__release_candidates__none__all)
{
    BOOST_REQUIRE_EQUAL(release_candidates(0, 0, 0), max_uint64);
}

BOOST_AUTO_TEST_CASE(memory_release__release_candidates__each__excluded)
{
    BOOST_REQUIRE_EQUAL(release_candidates(0b0001, 0b0010, 0b0100),
        system::bit_not<uint64_t>(0b0111));
}

BOOST_AUTO_TEST_CASE(memory_release__release_candidates__all__none)
{
...
BOOST_AUTO_TEST_CASE(memory_release__release_below__word_above_count__zero)
{
    BOOST_REQUIRE_EQUAL(release_below(max_uint64, 64, 64), zero);
    BOOST_REQUIRE_EQUAL(release_below(max_uint64, 10, 64), zero);
}

BOOST_AUTO_TEST_CASE(memory_release__release_below__word_below_count__all)
{
...
BOOST_AUTO_TEST_CASE(memory_release__release_below__boundary__low_bits)
{
...
BOOST_AUTO_TEST_CASE(memory_release__page_mask__disjoint__zero)
{
...
BOOST_AUTO_TEST_CASE(memory_release__page_mask__contained__expected)
{
...
BOOST_AUTO_TEST_CASE(memory_release__page_mask__spanning__clamped)
{
...
BOOST_AUTO_TEST_CASE(memory_release__page_mask__full_word__all)
{
...
BOOST_AUTO_TEST_CASE(memory_release__next_run__empty__none)
{
...
BOOST_AUTO_TEST_CASE(memory_release__next_run__single_page__found)
{
...
BOOST_AUTO_TEST_CASE(memory_release__next_run__word_spanning__joined)
{
...
BOOST_AUTO_TEST_CASE(memory_release__next_run__from_skips__second)
{
...
BOOST_AUTO_TEST_CASE(memory_release__next_run__page_bound__clipped)
{
...
BOOST_AUTO_TEST_CASE(memory_release__bit_run__unset_page__empty)
{
...
BOOST_AUTO_TEST_CASE(memory_release__bit_run__interior_page__extent)
{
...
BOOST_AUTO_TEST_CASE(memory_release__bit_run__word_spanning__extent)
{
...
BOOST_AUTO_TEST_CASE(memory_release__bit_run__beyond_pages__empty)
{
    const uint64_t words[]{ max_uint64, max_uint64 };
